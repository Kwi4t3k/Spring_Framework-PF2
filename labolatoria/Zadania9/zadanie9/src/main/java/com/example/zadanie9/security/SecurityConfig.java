package com.example.zadanie9.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthFilter jwtAuthFilter, AuthenticationProvider authProvider) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/vehicles/allActive").hasAnyRole("USER", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/rentals/getRented").hasAnyRole("USER", "ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/rentals/isRented/**").hasAnyRole("USER","ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/rentals/active/**").hasAnyRole("USER","ADMIN")
